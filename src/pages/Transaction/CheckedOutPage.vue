  ...
  export default {
    ...
    methods:{
      async getActiveDiscount(){
        this.isLoading = true;
        this.data      = await this._getData('json/checked-out');
    ...
    columns : [
      ...
      {name: 'arrivalDate'      , required: true, label: 'Arrival Date'     , field: 'arrivalDate'     , align: 'left' , sortable: true},
      {name: 'departureDate'    , required: true, label: 'Departure Date'   , field: 'departureDate'   , align: 'left' , sortable: true},
